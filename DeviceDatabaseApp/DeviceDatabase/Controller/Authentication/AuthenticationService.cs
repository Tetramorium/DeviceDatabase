...
namespace DeviceDatabase.Controller.Authentication
{
    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        {
            public InternalUserData(string username, string email, string hashedPassword, List<string> roles)
            {
                Username = username;
                Email = email;
        ...
        private static readonly List<InternalUserData> _users = new List<InternalUserData>()
        {
            ...
            "MB5PYIsbI2YzCUe34Q5ZU2VferIoI4Ttd+ydolWV0OE=", new List<string> { "Administrators" }),
            new InternalUserData("John", "john@company.com",
            "hMaLizwzOQ5LeOnMuj+C6W75Zl5CXXYbwDSHWW9ZOXc=", new List<string>())
        };
